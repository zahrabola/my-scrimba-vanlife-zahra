...
createServer({
    ...
    seeds(server) {
        ...
        // new user - madeup must use to be able to log in
        server.create("user", { id: "123", email: "b@b.com", password: "b123", name: "Bob" })
    },
    ...
    routes() {
        ...
        this.post("/login", (schema, request) => {
            ...
            //  This is an extremely naive version of authentication.Don't
